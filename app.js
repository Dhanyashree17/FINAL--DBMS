    ...
    if (products.length > 0) // if has data
    {
        products.forEach(product => {
            ...
            newProduct.innerHTML =
                ...
                <div class="kg">Kg: ${product.kg}</div>
...
const addToCart = (product_id) => {
    ...
    // Decrease the kilograms based on the quantity
    ...
    if (positionProduct >= 0) {
        ...
        // Make a request to your backend to update product kg
        fetch(`http://localhost:3000/updateProductKg/${product_id}`, {
            method: 'PUT',
            headers: {
        ...
        .catch(error => {
            console.error('Error updating product kg:', error);
        });
    }
